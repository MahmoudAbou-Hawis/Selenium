...
public class DynamicLoading {
    ...
    public ExamplePage OpenExamplePageInNewTap()
    {
        Actions actions = new Actions(driver);
        actions.keyDown(Keys.LEFT_CONTROL).moveToElement(driver.findElement(exampleButton)).click().perform();
        return new ExamplePage(driver);
    }
    ...
    public class ExamplePage
    {
        ...
        {
            return driver.findElement(statButton).isDisplayed();
        }
